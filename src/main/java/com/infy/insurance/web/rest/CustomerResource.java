...
import com.infy.insurance.web.rest.errors.BadRequestAlertException;
import com.infy.insurance.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "insuranceCustomer";
